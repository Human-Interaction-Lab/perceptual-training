...
describe('User Model Test', () => {
    ...
    describe('User Methods', () => {
        it('should correctly identify when reminder is needed for training', async () => {
            // Create a date at the start of the day to avoid time-of-day issues
